...
public class Main {
    ...
    public static void chooseMenu(MaterialManagement materialManagement, Scanner scanner) {
        int choice;
        do {
            menu();
            ...
            switch (choice) {
                ...
                case 3: {
                    updateMaterial(materialManagement, scanner);
                    break;
                }
                case 4: {
    ...
    public static void removeMaterial(MaterialManagement materialManagement, Scanner scanner) {
        System.out.println("Nhập vị trí bạn muốn sửa");
        int index = scanner.nextInt();
        materialManagement.deleteMaterial(index);
    }

    public static void updateMaterial(MaterialManagement materialManagement, Scanner scanner) {
    ...
    private static void showMaterialListInfo(Material[] materials) {
        for (Material material : materials) {
            ...
            double realMoney = material.getRealMoney();
